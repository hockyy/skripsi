...
\begin{figure}
 ...
 \caption{Grafik Waktu \textit{Resolve} Operasi Lokal pada \textit{Shell} Setiap Variasi Klien atau \textit{Peers} PeerToCP}
 \label{fig:13-5}
\end{figure}
