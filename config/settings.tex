...
% Judul laporan.
\def\judul{PeerToCP: Editor Kode dan \textit{Shared Shell} Kolaboratif dalam Waktu Nyata Berbasis {WebRTC}}
%
% Tulis kembali judul laporan, kali ini akan diubah menjadi huruf kapital
\Var{\Judul}{PeerToCP: Editor Kode dan \textit{Shared Shell} Kolaboratif dalam Waktu Nyata Berbasis {WebRTC}}
%
% Tulis kembali judul laporan namun dengan bahasa Ingris
\def\judulInggris{PeerToCP: WebRTC Based Real-Time Collaborative Code Editor and Shared Shell}
...
% penguji/sekretariat
\def\tanggalSiapSidang{28 November 2022}
%
